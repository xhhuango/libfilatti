...
int strength_trackbar_value = (int) (tiltShift.get_strength() * 100);
...
void on_trackbar(int, void*) {
    ...
    std::cout << "Strength=" << strength_trackbar_value
    << ", Radius=" << radius_trackbar_value
    << ", Feathering=" << feathering_trackbar_value
    << ", Angle=" << angle_trackbar_value << std::endl;

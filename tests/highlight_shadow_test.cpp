...
int main() {
    ...
    cv::createTrackbar(SHADOW_TONE_WIDTH_TRACKBAR_NAME, WINDOW_NAME, &shadow_tone_width_trackbar_value, 50,
                       on_trackbar);

    cv::createTrackbar(HIGHLIGHT_AMOUNT_TRACKBAR_NAME, WINDOW_NAME, &highlight_amount_trackbar_value, 200, on_trackbar);
    cv::createTrackbar(HIGHLIGHT_TONE_WIDTH_TRACKBAR_NAME, WINDOW_NAME, &highlight_tone_width_trackbar_value, 50,
                       on_trackbar);
